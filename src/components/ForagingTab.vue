...
export default {
  ...
  data() {
    return {
      skillID: 13,
      itemIndexStart: 0, //itemStore.resourceItems.findIndex(t => t.id === this.foragingStore[0].resourceID) //this code will get the start index of itemIDs, but I don't know how to run it after everything is loaded. Also, it hardcodes all activity items which could limit further development.
    }
  },
  methods: {
